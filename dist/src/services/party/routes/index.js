...
var routes = exports.routes = (0, _appRoute2.default)([['get', '/parties', (0, _allow2.default)('auth'), 'all'], ['post', '/parties', /* allow('auth'), allow('admin'), */'create'], ['get', '/party/:party_id', (0, _allow2.default)('auth'), 'one'], ['put', '/party/:party_id', (0, _allow2.default)('auth'), (0, _allow2.default)('admin'), 'update'], ['delete', '/party/:party_id', (0, _allow2.default)('auth'), (0, _allow2.default)('admin'), 'remove'], ['post', '/party/:party_id/follow', (0, _allow2.default)('auth'), 'follow'], ['delete', '/party/:party_id/unfollow', (0, _allow2.default)('auth'), 'unfollow'], ['post', '/party/:party_id/members', (0, _allow2.default)('auth'), (0, _allow2.default)('admin'), 'addMember'], ['delete', '/party/:party_id/members', (0, _allow2.default)('auth'), (0, _allow2.default)('admin'), 'removeMember']], new _controllers2.default());